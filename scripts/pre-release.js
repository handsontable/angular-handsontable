...
const SRC_CE_PACKAGE_PATH = path.resolve('./lib/ce/package.json');
const SRC_PRO_PACKAGE_PATH = path.resolve('./lib/pro/package.json');
...
const SRC_CE_PACKAGE = fse.readJsonSync(SRC_CE_PACKAGE_PATH);
const SRC_PRO_PACKAGE = fse.readJsonSync(SRC_PRO_PACKAGE_PATH);
...
CE_PACKAGE.keywords = SOURCE_PACKAGE.keywords.concat(SRC_CE_PACKAGE.keywords);
...
PRO_PACKAGE.keywords = SOURCE_PACKAGE.keywords.concat(SRC_PRO_PACKAGE.keywords);
