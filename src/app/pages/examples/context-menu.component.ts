...
@Component({
  template: `
    <div class="docs-content">
      ...
      <p>Define two tables to tests context menu actions across two instances of <code>hot-table</code></p>
      <iframe class="stackblitz" style="min-height: 300px;"
      src="https://stackblitz.com/edit/angular-handsontable-issue-28?embed=1
      ...
      <iframe class="stackblitz" style="min-height: 600px;"
        src="https://stackblitz.com/edit/angular-handsontable-issue-28?embed=1
        &file=app/app.component.ts&hideExplorer=1&hideNavigation=1&view=editor">
      </iframe>
