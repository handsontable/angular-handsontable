...
@Component({
  template: `
    <div class="docs-content">
      <h1>QuickStart</h1>
        <h2 id="prepare-project">Przygotowanie projektu</h2>
        ...
        <h2 id="install-wrapper">Dodanie <code>angular-handsontable</code> do projektu.</h2>
        ...
        <h2 id="zonejs-workaround">Załadowanie Handsontable przed Zone.js</h2>
        ...
        <h2 id="add-wrapper-in-module">Dodanie wrappera do głównego modułu aplikacji</h2>
        ...
        <h2 id="use-wrapper-in-template">Dodanie elementu do szablonu komponentu</h2>
