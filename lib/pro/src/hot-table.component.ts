...
export class HotTableComponent implements AfterContentInit, OnChanges, OnDestroy, OnInit {
  ...
  @Input() afterRenderer: (TD: Element, row: number, col: number, prop: string | number,
    value: string, cellProperties: Handsontable.GridSettings) => void;
  ...
  @Input() beforeRenderer: (TD: Element, row: number, col: number, prop: string | number,
    value: string, cellProperties: Handsontable.GridSettings) => void;
  ...
  @Input() afterDropdownMenuDefaultOptions: (predefinedItems: any[]) => void;
  @Input() afterDropdownMenuHide: (instance: any) => void;
  @Input() afterDropdownMenuShow: (instance: any) => void;
  @Input() afterFilter: (formulasStack: any[]) => void;
  @Input() afterTrimRow: (rows: any[]) => void;
  @Input() afterUntrimRow: (rows: any[]) => void;
  @Input() beforeAddChild: (parent: object, element: object | void, index: number | void) => void;
  @Input() beforeDetachChild: (parent: object, element: object) => void;
  @Input() beforeDropdownMenuSetItems: (menuItems: any[]) => void;
  @Input() beforeDropdownMenuShow: (instance: any) => void;
  @Input() beforeFilter: (formulasStack: any[]) => void;
  @Input() hiddenColumn: (column: number) => void;
