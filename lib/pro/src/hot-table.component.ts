...
export class HotTableComponent implements AfterContentInit, OnChanges, OnDestroy, OnInit {
  ...
  @Input() dropdownMenu: boolean | object | string[];
  @Input() filters: boolean;
  @Input() fixedRowsBottom: number;
  @Input() formulas: boolean | object;
  ...
  @Input() afterDropdownMenuHide: (instance: Handsontable.plugins.dropdownMenu) => void;
  @Input() afterDropdownMenuShow: (dropdownMenu: Handsontable.plugins.dropdownMenu) => void;
  @Input() afterFilter: (conditionsStack: object[]) => void;
  @Input() afterTrimRow: (rows: number[]) => void;
  @Input() afterUntrimRow: (rows: number[]) => void;
  ...
  @Input() beforeDropdownMenuSetItems: (menuItems: object[]) => void;
  @Input() beforeDropdownMenuShow: (dropdownMenu: Handsontable.plugins.dropdownMenu) => void;
  @Input() beforeFilter: (conditionsStack: any[]) => void;
